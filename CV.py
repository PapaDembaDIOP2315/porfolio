...
with st.sidebar:
    ...
    st.write("FORMATIONS")
    st.write("2022: BAC L2")
    st.write("2022-2025: Licence 3 en Geographie")
...
st.write("Poste d'adjoint  du president de la communication de l'amical des etudiants thièsois")
...
st.write("Maitrise des techniques de collecte données:application Mobile Topographer,Kono Toolbox")
